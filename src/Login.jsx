...
export default function Login({ onSubmit, onNavigateToSignUp }) {
  ...
  function handleSubmit(e) {
    ...
    setError("");
    setSubmitting(true);
    Promise.resolve(onSubmit ? onSubmit({ email, password }) : null).finally(() =>
      setSubmitting(false)
    );
  }
      ...
      <div className="min-h-screen grid md:grid-cols-2">
        ...
        <div className="relative hidden md:flex flex-col justify-between bg-black text-white px-12 py-10 overflow-hidden">
          ...
          <div className="relative z-10 max-w-sm">
            ...
            <p className="text-white/60 text-[15.5px] mt-4 leading-relaxed">
              Sign in to pick up where you left off — saved searches, booked
              rooms, and equipment reservations all in one place.
            </p>
          </div>
        ...
        <div className="flex items-center justify-center px-6 py-16">
          <div className="w-full max-w-sm">
            ...
            <h2 className="font-display font-semibold text-3xl mb-2">Sign in</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label
                    htmlFor="password"
                    className="block text-[13.5px] font-medium text-neutral-700"
                  >
                    Password
                  </label>
                  <a
                    href="#forgot-password"
                    className="text-[13px] text-neutral-500 hover:text-red-500"
                  >
                    Forgot password?
                  </a>
                </div>
